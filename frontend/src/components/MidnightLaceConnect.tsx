      ...
      <div className="card midnight-wallet-card" data-testid="midnight-wallet-connected">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.85rem' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              style={{ fontSize: '0.8rem', padding: '0.35rem 0.75rem', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '6px', border: '1px solid var(--border)' }}
            >
              💧 Faucet
            </a>
            <button
        ...
        <div style={{ marginTop: '1rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '0.85rem' }}>
          <div style={{ background: 'var(--surface-alt)', padding: '0.75rem 1rem', borderRadius: '8px', border: '1px solid var(--border)' }}>
            <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '0.2rem', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Unshielded Address</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              <code className="hash" style={{ fontSize: '0.78rem' }}>{addresses.unshieldedAddress.slice(0, 18)}...{addresses.unshieldedAddress.slice(-8)}</code>
          ...
          {addresses.shieldedAddress && (
            <div style={{ background: 'var(--surface-alt)', padding: '0.75rem 1rem', borderRadius: '8px', border: '1px solid var(--border)' }}>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '0.2rem', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Shielded Address (ZK)</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <code className="hash" style={{ fontSize: '0.78rem' }}>{addresses.shieldedAddress.slice(0, 18)}...{addresses.shieldedAddress.slice(-8)}</code>
          ...
          {balance && (
            <div style={{ background: 'var(--surface-alt)', padding: '0.75rem 1rem', borderRadius: '8px', border: '1px solid var(--border)' }}>
              <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '0.2rem', textTransform: 'uppercase', letterSpacing: '0.04em' }}>Available Balance</div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <h3 style={{ margin: '0 0 0.35rem', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <span>🔑</span> Lace Wallet Connection
          </h3>
