...
async function main() {
  ...
  const activityPayload = {
    ...
    circuitsExercised: [
      'stellar_vault_escrow::deposit',
      'stellar_vault_escrow::release',
      'stellar_vault_escrow::refund',
      'stellar_vault_escrow::resolveSplit',
      'stellar_vault_feedback::submitRating',
    ],
